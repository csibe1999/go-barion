...
// 	client := barion.NewClient("http://localhost", "XXX")
...
// 	res, err := client.StartPayment(&barion.PaymentRequest{})
// 	if err == nil {
...
// 	res, err := client.GetPaymentState("8a879c1fa4c9ea118bbd001dd8b71cc4")
// 	if err != nil {
// 		t.Fatalf("Should not be err")
// 	}
